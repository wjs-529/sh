...
moltbot_menu() {
	...
	send_stats "Clawdbot/moltbot のインストール"
	get_install_status() {
	...
	change_model() {
		printf "設定するモデル名を入力してください (例: openrouter/openai/gpt-4o):"
		read model
	...
	change_tg_bot_code() {
		printf "TG ロボットが受信した接続コードを入力してください (例: ペアリング コード: NYA99R2F:"
		read code
